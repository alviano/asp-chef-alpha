...
<Operation {id} {operation} {options} {index} {default_extra_options} {add_to_recipe} {keybinding}>
    <div slot="description">
        ...
        <p>
            The range of selectable values can be specified by means of constants or by a unary predicate.
            If unary predicates are used, the extreme values among all models in input are used.
        </p>
    </div>
    <InputGroup>
